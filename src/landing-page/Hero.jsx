      ...
      <div className="flex gap-5 mt-4 ">
        ...
        <div className="">
          <div className="flex gap-4">
            ...
            <div>
              <p className="text-[#6941C6] mb-2">Phoenix Baker • 1 Jan 2023</p>
              <p className="text-[#1A1A1A] mb-2 font-bold">
          ...
          <div className="flex mt-5 gap-4">
            ...
            <div>
              ...
              <p>
                The rise of RESTful APIs has <br /> been met by a rise in tools
                for <br />
  ...
  <section className="px-10">
       <div className="flex gap-5 mt-13 ">
        <div>
            ...
            <div>
<p className="text-[#6941C6] mb-2">Olivia Rhye • 1 Jan 2023</p>
<p  className="text-[#1A1A1A] mb-2 font-bold">Grid system for better Design User Interface</p>
<p>A grid system is a design tool used to arrange content on a webpage. It is a <br />series of vertical and horizontal lines that create a matrix of intersecting <br /> points, which can be used to align and organize page elements. Grid systems <br /> are used to create a consistent look and feel across a website, and can help <br />to make the layout more visually appealing and easier to navigate.</p>
 <div className=" flex gap-3">
                <button className="text-[#6941C6] bg-[#6941C6]/20 text-[14px] rounded-full mt-4 px-3 py-2">
                  Design
                </button>
...
<section className="px-10 mt-7">
 ...
 <div className="flex mt-4 gap-5">
    <div>
        ...
        <p className="mt-2">Like to know the secrets of transforming a 2-14 <br />team into a 3x Super Bowl winning Dynasty?</p>
        <div className=" flex gap-3">
                <button className="text-[#6941C6] bg-[#6941C6]/20 text-[14px] rounded-full mt-4 px-3 py-2">
                  Leadership
                </button>
     ...
     <div>
        ...
        <p className="mt-2">Mental models are simple expressions of complex <br />processes or relationships.</p>
       <div className=" flex mt-2 gap-3">
     ...
     <div>
        ...
        <p className="mt-2">Introduction to Wireframing and its Principles. <br /> Learn from the best in the industry.</p>
...
<section className="px-10 mt-9">
 <div className="flex mt-4 gap-5">
    <div>
        ...
        <p className="font-bold mt-3">How collaboration makes us <br />better designers</p>
        <p className="mt-2">Collaboration can make our teams stronger, and <br /> our individual designs better.</p>
        <div className=" flex gap-3">
                <button className="text-[#6941C6] bg-[#6941C6]/20 text-[14px] rounded-full mt-4 px-3 py-2">
                  Design
                </button>
     ...
     <div>
        ...
        <p className="font-bold mt-2">Our top 10 Javascript <br /> frameworks to use</p>
        <p className="mt-2">JavaScript frameworks make development easy <br />with extensive features and functionalities.</p>
       <div className=" flex mt-2 gap-3">
     ...
     <div>
        ...
        <p className="font-bold mt-3">Podcast: Creating a better <br /> CX Community</p>
        <p className="mt-2">Starting a community doesn’t need to be <br /> complicated, but how do you get started?</p>
       <div className=" flex mt-1 gap-3">
                <button className="text-[#6941C6] bg-[#6941C6]/20 text-[14px] rounded-full mt-4 px-3 py-2">
                  Podcast
                </button>
